...
\begin{abstract}
Unfolding codes MAXED and Gravel are applied to the theoretical problem of in-core, multi-isotope, fission chamber detectors.
This includes a study of the variation of default spectra, as well as analysis of different isotopic groupings, including Cd and Gd shielded isotopes.
The analysis demonstrates an overall improvement on the group-wise and mean absolute errors compared with other, previously studied unfolding methods, the best case showing a mean, group-wise error of 18.5\%.
\end{abstract}

% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
neutron spectroscopy, fission chambers, maxed, gravel
\end{IEEEkeywords}
